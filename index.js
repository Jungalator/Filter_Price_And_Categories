...
filterPriceForm.className = "fiter-price-form";
...
const filterPrice = document.createElement("button");
filterPrice.type = "submit";
filterPrice.textContent = "Фильтровать";
filterPrice.className = "filter-price-btn";
